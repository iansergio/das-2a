...
SOURCE_TABLE    = str("pedido") # Tabela de origem do professor
...
TARGET_TABLE    = str("pedido") # Tabela de destino
TARGET_USER     = str(os.getenv("SQL_TARGET_USER"))
TARGET_PASSWORD = str(os.getenv("SQL_TARGET_PASSWORD"))

BATCH_SIZE      = int("5000")

@app.timer_trigger(schedule="30 15 * * *", arg_name="timer", run_on_startup=False)
